public class Tree {
    ...
    public static int diameter(Node root){
        ...
        int left_height=BinaryTree.height(root.left);// find the height of left subtree
        int right_height=BinaryTree.height(root.right);
        int curDiameter = left_height + right_height + 1;
        return Math.max(curDiameter, Math.max(ld, rd));
    }
